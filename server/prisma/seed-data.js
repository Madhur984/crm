/* Single source of truth for demo data — shared by the SQLite seed (seed.js)
   and the Firestore seed (seed-firebase.js). */
...
export const nameToId = { "Motor Control PCBA": "p1", "Sensor Array Module": "p2" };

export const NOTIFICATIONS = [
  { projectId: "p1", cat: "Commercial", title: "Payment received", body: "INV-8821 ($930,000) has been reconciled against milestone 2.", read: false },
  { projectId: "p1", cat: "Technical", title: "Clarification C-104 opened", body: "Isolation voltage confirmation requested for ACS37800 (L-005).", read: false },
  { projectId: "p2", cat: "Technical", title: "RF module allocation", body: "nRF9160 on allocation; a second qualified source is being validated.", read: false },
  { projectId: "p1", cat: "Logistics", title: "Manufacturing started", body: "Production run initiated; first article inspection passed.", read: true },
  { projectId: "p2", cat: "Compliance", title: "Compliance review scheduled", body: "US compliance review is estimated to begin Aug 12.", read: true },
];

export const USERS = [
  { email: "demo@reconcore.app", name: "J. Weber", role: "Procurement Lead" },
  { email: "alvarez@reconcore.app", name: "R. Alvarez", role: "Procurement Lead" },
];

export const ORG_NAME = "Nordwerk Industrial GmbH";
