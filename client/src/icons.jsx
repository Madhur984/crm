...
export function Icon({ size = 16, color = "currentColor", strokeWidth = 2, children, style, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color}
      strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, ...style }} {...rest}>
      {children}
    </svg>
  );
}
...
export const Upload = (p) => <Icon {...p}><path d="M4 19h16"/><path d="M12 15V3"/><polyline points="7 8 12 3 17 8"/></Icon>;
